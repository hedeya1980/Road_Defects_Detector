...
string bag_path = "C:/Users/hedey/Documents/20211127_150031.bag";
...
int main(int argc, char* argv[]) try
{
    for (const auto& entry : fs::directory_iterator(test_input_path))
    {
        ...
        cv::Mat I = cv::imread(fileName, IMREAD_COLOR);
        if (I.empty())
        {
        ...
        else
        {
            ...
            //cv::Mat rgb_test = I.clone();
            //detectObjects(test_f, I, bBoxes, confThreshold, nmsThreshold,
        ...
        //while(!viewer->wasStopped()) && waitKey(1)< 0 && getWindowProperty(window_name, WND_PROP_AUTOSIZE) >= 0
    {
        ...
        */
        ...
        //imwrite("C:/Users/hedey/source/repos/Road_Defects_Detector/RGB_images/"+ zero_padding(std::to_string(f), 5) +".png", imageRGB);
