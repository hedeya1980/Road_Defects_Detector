...
int main(int argc, char* argv[]) try
{
    ...
    cfg.enable_device_from_file("D:/Eslam/20211023_111231.bag");
        ...
        //while(!viewer->wasStopped()) && waitKey(1)< 0 && getWindowProperty(window_name, WND_PROP_AUTOSIZE) >= 0
    {
        ...
        */
        ...
        std::cout << "Depth Frame Width: " << w << ", " << "Depth Frame Height: " << h << std::endl;
        ...
        */
        ...
        if (bBoxes.size() > 0)
        {
            for (auto bBox : bBoxes)
            {
                ...
                float planarPoint3d_tl_depth[3], planarPoint3d_tr_depth[3], planarPoint3d_bl_depth[3], planarPoint3d_br_depth[3];
                ...
                */
                ...
                rs2_deproject_pixel_to_point(planarPoint3d_tl, &color_intrin, depth_pixel_tl, pixel_distance_in_meters_tl);
                rs2_transform_point_to_point(planarPoint3d_tl_depth, &color_extrin_to_depth, planarPoint3d_tl);
                std::cout << "tl: " << planarPoint3d_tl[0] << ", " << planarPoint3d_tl[1] << ", " << planarPoint3d_tl[2] << ", " << std::endl;
                std::cout << "tl_depth: " << planarPoint3d_tl_depth[0] << ", " << planarPoint3d_tl_depth[1] << ", " << planarPoint3d_tl_depth[2] << ", " << std::endl;
                //rs2_deproject_pixel_to_point(planarPoint3d_tr, &inrist, depth_pixel_tr, pixel_distance_in_meters_tr);
                rs2_deproject_pixel_to_point(planarPoint3d_tr, &color_intrin, depth_pixel_tr, pixel_distance_in_meters_tr);
                rs2_transform_point_to_point(planarPoint3d_tr_depth, &color_extrin_to_depth, planarPoint3d_tr);
                std::cout << "tr: " << planarPoint3d_tr[0] << ", " << planarPoint3d_tr[1] << ", " << planarPoint3d_tr[2] << ", " << std::endl;
                std::cout << "tr_depth: " << planarPoint3d_tr_depth[0] << ", " << planarPoint3d_tr_depth[1] << ", " << planarPoint3d_tr_depth[2] << ", " << std::endl;
                //rs2_deproject_pixel_to_point(planarPoint3d_bl, &inrist, depth_pixel_bl, pixel_distance_in_meters_bl);
                rs2_deproject_pixel_to_point(planarPoint3d_bl, &color_intrin, depth_pixel_bl, pixel_distance_in_meters_bl);
                rs2_transform_point_to_point(planarPoint3d_bl_depth, &color_extrin_to_depth, planarPoint3d_bl);
                std::cout << "bl: " << planarPoint3d_bl[0] << ", " << planarPoint3d_bl[1] << ", " << planarPoint3d_bl[2] << ", " << std::endl;
                std::cout << "bl_depth: " << planarPoint3d_bl_depth[0] << ", " << planarPoint3d_bl_depth[1] << ", " << planarPoint3d_bl_depth[2] << ", " << std::endl;
                //rs2_deproject_pixel_to_point(planarPoint3d_br, &inrist, depth_pixel_br, pixel_distance_in_meters_br);
                rs2_deproject_pixel_to_point(planarPoint3d_br, &color_intrin, depth_pixel_br, pixel_distance_in_meters_br);
                rs2_transform_point_to_point(planarPoint3d_br_depth, &color_extrin_to_depth, planarPoint3d_br);
                std::cout << "br: " << planarPoint3d_br[0] << ", " << planarPoint3d_br[1] << ", " << planarPoint3d_br[2] << ", " << std::endl;
                std::cout << "br_depth: " << planarPoint3d_br_depth[0] << ", " << planarPoint3d_br_depth[1] << ", " << planarPoint3d_br_depth[2] << ", " << std::endl;
                ...
                std::vector<float> z_vec_depth = { planarPoint3d_tl_depth[2], planarPoint3d_tr_depth[2], planarPoint3d_bl_depth[2], planarPoint3d_br_depth[2] };
                ...
                //pcl::PointCloud<Cloud_Type>::Ptr filterCloud = pointProcessorI->FilterCloud(cloud, 0.1f, Eigen::Vector4f(std::max(std::min(planarPoint3d_bl_depth[0], planarPoint3d_tl_depth[0]), minPt.x), std::max(std::min(planarPoint3d_tl_depth[1], planarPoint3d_tr_depth[1]), minPt.y), get<0>(z_min_max_depth), 1), Eigen::Vector4f(std::min(std::max(planarPoint3d_tr_depth[0], planarPoint3d_br_depth[0]), maxPt.x), std::min(std::max(planarPoint3d_bl_depth[1], planarPoint3d_br_depth[1]), maxPt.y), get<1>(z_min_max_depth), 1)); //0.25f
                ...
                pcl::PointCloud<Cloud_Type>::Ptr filterCloud = pointProcessorI->FilterCloud(cloud, 0.1f, Eigen::Vector4f(planarPoint3d_bl_depth[0], planarPoint3d_tr_depth[1], planarPoint3d_br_depth[2], 1), Eigen::Vector4f(planarPoint3d_br_depth[0], planarPoint3d_br_depth[1], planarPoint3d_tr_depth[2], 1)); //0.25f
