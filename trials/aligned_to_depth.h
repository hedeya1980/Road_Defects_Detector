        ...
        if (bBoxes.size() > 0)
        {
            for (auto bBox : bBoxes)
            {
                ...
                */
                ...
                rs2_deproject_pixel_to_point(planarPoint3d_tl, &depth_intrin, depth_pixel_tl, pixel_distance_in_meters_tl);
                ...
                rs2_deproject_pixel_to_point(planarPoint3d_tr, &depth_intrin, depth_pixel_tr, pixel_distance_in_meters_tr);
                ...
                rs2_deproject_pixel_to_point(planarPoint3d_bl, &depth_intrin, depth_pixel_bl, pixel_distance_in_meters_bl);
                ...
                rs2_deproject_pixel_to_point(planarPoint3d_br, &depth_intrin, depth_pixel_br, pixel_distance_in_meters_br);
